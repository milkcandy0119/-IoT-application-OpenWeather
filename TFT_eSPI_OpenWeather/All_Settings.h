...
#define WIFI_SSID      "Milkcandy"
#define WIFI_PASSWORD  "momo1234"

#define TIMEZONE TW // See NTP_Time.h tab for other "Zone references", UK, usMT etc
...
const String api_key = "992c45bdb8b21aae704a7413fcd9255a";

// Set the forecast longitude and latitude to at least 4 decimal places
const String latitude =  "25.17770"; // 90.0000 to -90.0000 negative for Southern hemisphere
const String longitude = "121.44275"; // 180.000 to -180.000 negative for West
